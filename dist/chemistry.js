 ...
 * // → "N2 + 3H2 <=> 2NH3"
 */
export function buildReaction(reactants, products, arrow = '->', above, below) {
...
export function parseFormula(formula) {
    ...
    const parsePart = (str, multiplier = 1) => {
        const result = {};
        let i = 0;
        while (i < str.length) {
 ...
 */
export function getElement(symbolOrName) {
